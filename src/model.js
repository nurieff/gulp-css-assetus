...
function AssetusModel(list, str) {
  ...
  this._padding = 'padding' in config ? parseInt(config.padding) : this.list.assetus.config.padding;
  this._algorithm = 'algorithm' in config ? config.algorithm : this.list.assetus.config.algorithm;
}
...
AssetusModel.prototype.position = function (spriteName) {
 ...
 */
AssetusModel.prototype.all = function () {
